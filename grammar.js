...
export default grammar({
	...
	rules: {
		...
		// about half the throughput (14,279 -> 7,457 bytes/ms); the lexical
		// split gets it back (15,190 bytes/ms) and leaves ordinary input
		// unchanged. `test/corpus/bench/` holds the inputs.
		Number: ($) =>
			choice(
